...
class PostsController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Posts Berhasil DiHapus (Silahkan cek trashed post)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success', 'Posts Berhasil Direstore (Silahkan cek list post)');
    }
